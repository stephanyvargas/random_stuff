...
2. REFs: 
	...
	- Relative commits are powerful, but we will introduce two simple ones here:
		- Moving upwards one commit at a time with `^`. For example:  saying `main^` is equivalent to "the first parent of main". `main^^` is the grandparent (second-generation ancestor) of main.
		```shell
		git checkout main^
		```
	...
	<p align="center">
	<img src="git_refs.png" width="900" height="400" />
	</p>
